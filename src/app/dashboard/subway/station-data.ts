export interface SubwayLine {
  id: string;       // API subwayId (e.g. "1002")
  name: string;     // e.g. "2호선"
  color: string;
  circular?: boolean;
  stations: string[];
  // Branch lines drawn separately
  branches?: { name: string; fromStation: string; stations: string[] }[];
}
...
export const SUBWAY_LINES: SubwayLine[] = [
  {
    ...
    stations: [
      ...
      "영등포","영등포시장","신도림","구로","구일","개봉","오류동","온수","역곡","소사",
      "부천","중동","송내","부개","부평","백운","동암","간석","주안","도화","제물포",
      "도원","동인천","인천"
    ],
  },
  {
  ...
  },
  {
    ...
    color: "#00A5DE",
    stations: [
      "진접","오남","별내별가람","당고개","상계","노원","창동","쌍문","수유","미아","미아사거리",
      "길음","성신여대입구","한성대입구","혜화","동대문","동대문역사문화공원","충무로","명동",
      "회현","서울역","숙대입구","삼각지","신용산","이촌","동작","이수","사당","남태령",
  ...
  },
  {
    ...
    stations: [
      ...
      "애오개","충정로","서대문","광화문","종로3가","을지로4가","동대문역사문화공원",
  ...
  },
  {
    ...
    color: "#747F00",
    stations: [
      "석남","인천시청","검암","완정","아라뱃길","계산","경인교대입구","귤현","부평구청",
      "산곡","까치울","온수","천왕","광명사거리","철산","가산디지털단지","남구로","대림",
      "신풍","보라매","신대방삼거리","장승배기","상도","숭실대입구","남성","이수","반포",
      "논현","학동","강남구청","청담","뚝섬유원지","건대입구","어린이대공원","군자","중곡",
      "용마산","사가정","면목","상봉","중화","먹골","태릉입구","공릉","하계","중계","마들",
      "노원","도봉산","수락산","마들","노원","도봉산"
    ],
  },
  {
    id: "1008",
    ...
    color: "#E6186C",
    stations: [
      "별내","다산","동구릉","구리","토평","암사","천호","강동구청","몽촌토성","잠실","석촌",
      "송파","가락시장","문정","장지","복정","산성","남한산성입구","단대오거리","신흥","수진",
      "모란"
    ],
  },
  {
...
export const LINE_MAP: Record<string, SubwayLine> = Object.fromEntries(
  SUBWAY_LINES.map((l) => [l.id, l])
);
...
export const UPDN_LABEL: Record<string, string> = {
  "0": "상행",
  "1": "하행",
};
