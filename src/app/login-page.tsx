...
export function LoginPage() {
  ...
  return (
    ...
    >
      {/* 배경 글로우 */}
      <div style={{ position: "absolute", top: "20%", left: "50%", transform: "translate(-50%, -50%)", width: "600px", height: "600px", background: "radial-gradient(circle, rgba(99,102,241,0.08) 0%, rgba(59,130,246,0.04) 50%, transparent 70%)", pointerEvents: "none" }} />
      <div style={{ position: "absolute", bottom: "10%", right: "10%", width: "300px", height: "300px", background: "radial-gradient(circle, rgba(16,185,129,0.06) 0%, transparent 70%)", pointerEvents: "none" }} />

      <div
        className="w-full max-w-md rounded-2xl border p-6 sm:p-10"
        style={{ background: "#ffffff", borderColor: "rgba(0,0,0,0.08)", boxShadow: "0 4px 24px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04)", position: "relative", zIndex: 1 }}
      >
        {/* 헤더 */}
        <div className="mb-8 text-center">
          <div className="mb-4 flex justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-full" style={{ background: "linear-gradient(135deg, #6366f1 0%, #3b82f6 100%)", boxShadow: "0 8px 32px rgba(99,102,241,0.3)" }}>
              <svg className="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
            </div>
          </div>
          <h1 className="text-3xl font-bold" style={{ background: "linear-gradient(135deg, #6366f1 0%, #3b82f6 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
            공공데이터 대시보드
          </h1>
          <p className="mt-2 text-sm" style={{ color: "#64748b" }}>한국 공공 데이터 기반 실시간 정보 서비스</p>
        </div>

        {/* 탭 */}
        <div className="mb-6 flex rounded-xl p-1" style={{ background: "#f1f5f9" }}>
          <button
